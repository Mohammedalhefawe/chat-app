...
class _SuggestionFreelanceApiService implements SuggestionFreelanceApiService {
  _SuggestionFreelanceApiService(
    ...
    baseUrl ??= 'http://192.168.2.45:8000/api/';
  }
  ...
  Future<SuggestedFreelance> getSpecialization(int page) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SuggestedFreelance>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SuggestedFreelance.fromJson(_result.data!);
    return value;
  }
