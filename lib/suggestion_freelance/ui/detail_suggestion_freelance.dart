...
class DetailSuggestionFreelanceScreen extends StatefulWidget {
  const DetailSuggestionFreelanceScreen({super.key});

  @override
  State<DetailSuggestionFreelanceScreen> createState() => _DetailSuggestionFreelanceScreenState();
}

class _DetailSuggestionFreelanceScreenState extends State<DetailSuggestionFreelanceScreen> {
